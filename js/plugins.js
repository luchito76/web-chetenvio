...
!(function(t) {
	t.fn.barfiller = function(i) {
		var n,
			e,
			o = t.extend({ barColor: '#16b597', tooltip: !0, duration: 1e3, animateOnResize: !0, symbol: '%' }, i),
			a = t(this),
			r = t.extend(o, i),
			s = a.width(),
			l = a.find('.fill'),
					...
					!/webkit/.test(navigator.userAgent.toLowerCase())
						...
						: /webkit/.test(navigator.userAgent.toLowerCase())
							...
							: /opera/.test(navigator.userAgent.toLowerCase())
								? '-o-transition'
								: /msie/.test(navigator.userAgent.toLowerCase()) ? '-ms-transition' : 'transition';
				},
				getTransition: function(t, i, n) {
					var o;
					return (
						'width' === n ? (o = { width: t }) : 'left' === n && (o = { left: t }),
						(i /= 1e3),
		...
		return f[i]
			...
			: 'object' != typeof i && i
				? void t.error('Method "' + method + '" does not exist in barfiller plugin!')
				: f.init.apply(this);
	};
})(jQuery);
